<form wire:submit.prevent="editCover">
    ...
    <div class="card-body lg:py-7.5 py-5">
        ...
        <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14 mt-5 ">
            ...
            <div class="my-5 w-60">
                <img src="{{ asset('storage/cover/images' ."/". $cover->image) }}" alt="{{ 'image cover: ' . $cover->title }}">
            </div>
        </div>

        <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14 mt-5">
            <div class="flex flex-col max-w-72 w-full">
                <label class="text-gray-900 text-sm font-semibold" for="image">Nueva Imagen</label>
            </div>
            <div class="">
        ...
        <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14 mt-5">
            ...
            <div class="w-full">
                <label class="">
                    <select wire:model="status" id="status" class="select @error('status') is-invalid @enderror"
                        required>
