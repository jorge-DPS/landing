<form wire:submit.prevent="createActivity">
    ...
    <div class="mb-10 row">
        ...
        <div class="mb-6">
            ...
            <div wire:loading wire:target="cover_image" class="text-blue-500 text-xs mt-2">
                Subiendo imagen...
            </div>
        </div>
        ...
        @if ($cover_image)
            <div class="mt-6">
                ...
                <div class="w-80 h-48 overflow-hidden rounded-lg border border-gray-300 bg-gray-50 shadow-sm">
                    <img src="{{ $cover_image->temporaryUrl() }}" alt="Imagen de Portada"
        ...
        <div class="flex items-center mb-4">
            ...
            <div class="w-2/3">
                <!-- Input para subir solo archivos PDF -->
                <input type="file" id="attachment" wire:model="attachment" accept="application/pdf"
                    class="file-input" />
                {{-- @error('attachment')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror --}}
                <!-- Indicador de carga -->
                <div wire:loading wire:target="attachment" class="text-blue-500 text-sm mt-1">Subiendo archivo...</div>
            </div>
        </div>

        <!-- Attachment Title -->
        <div class="flex items-center mb-4">
            <label for="attachment_title" class="w-1/3 text-gray-700">Título para el archivo</label>
