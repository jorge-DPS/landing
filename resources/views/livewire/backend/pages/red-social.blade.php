                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="px-6 py-4 border-b border-gray-200">
                                    <span  class="text-sm leading-5 text-gray-700">{{$red->platform}}</span>
                                </td>
                                <td class="px-6 py-4 border-b border-gray-200">
                                    <span  class="text-sm leading-5 text-gray-700">{{ $red->url }}</span>
                                </td>
                            </tr>
