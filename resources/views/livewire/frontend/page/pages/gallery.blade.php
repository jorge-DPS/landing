<main>
    ...
    <section style="background-image: url('{{ asset('storage/uploads/banner/' . $section->banner ) }}')" class="pt-[327px] xl:pt-[287px] lg:pt-[237px] sm:pt-[200px] xxs:pt-[180px] pb-[158px] xl:pb-[118px] lg:pb-[98px] sm:pb-[68px] xs:pb-[48px] text-center bg-no-repeat bg-cover bg-center relative z-[1] overflow-hidden before:absolute before:-z-[1] before:inset-0 before:bg-edblue/70 before:pointer-events-none">
                ...
                @forelse ( $images as $image )
                    <div class="space-y-[30px] lg:space-y-[20px]">
                        <div class="relative z-[1] group before:absolute before:inset-0 before:bg-etBlack/70 before:z-[0] before:opacity-0 before:transition before:duration-[400ms] hover:before:opacity-100">
                            <img src="{{ asset('storage/uploads/images/' . $image->filename) }}" alt="gallery-image" class="w-full aspect-square object-cover">
