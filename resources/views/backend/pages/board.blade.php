    ...
    <thead>
        <tr>
            ...
            <th class="min-w-[180px]">
                <span class="sort">
                    <span class="sort-label">Título</span>
            ...
            <th class="min-w-[180px]">
                <span class="sort">
                    <span class="sort-label">Título del CEO</span>
                    <span class="sort-icon"></span>
                </span>
            </th>
            <th class="min-w-[180px]">
                <span class="sort">
                    <span class="sort-label">Menú vínculado</span>
                    <span class="sort-icon"></span>
                </span>
            </th>
            <th class="w-[60px]"></th>
            ...
            <tr>
                ...
                <td>
                    <span class="badge badge-primary badge-pill gap-1.5">
                        <span class="badge badge-dot badge-light size-1.5"></span>
                        {{ $pag->menu->title }}
                    </span>
                </td>
                                ...
                                <div class="menu-item">
                                    <form action="{{ route('pages.destroy', $pag->id) }}" method="POST">
                                        ...
                                        <a class="menu-link" href="">
                                            ...
                                            <button type="submit" class="menu-title">Eliminar</button>
                                        </a>
                                    </form>
                                </div>
                            </div>
