            ...
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                ...
                <div class="flex items-center gap-2.5">
                    <div class="btn-conteiner">
                        <a class="btn-content" href="{{ route('pages.index') }}">
                            ...
                            <form action="{{ route('pages.update', [$page]) }}" method="POST" 
                                ...
                                <div class="card-body lg:py-7.5 py-5">
                                    ...
                                    <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14">
                                        <!-- Encabezado -->
                                        <div class="flex flex-col max-w-72 w-full">
                                            <h2 class="text-gray-900 text-lg font-semibold">Agregar Página</h2>
                                        </div>
                                    </div>
                                    <!-- Formulario -->
                                    <div class="mt-4 w-full">
                                        ...
                                        <div class="w-full mb-6">
                                            <div class="flex flex-wrap lg:flex-nowrap gap-3 items-center">
                                                <label for="title"
                                                    class="form-label w-full lg:max-w-xs text-sm font-medium text-gray-700">Título
                                                    de la página</label>
                                        ...
                                        <div class="w-full mb-6">
                                            <div class="flex flex-wrap lg:flex-nowrap gap-3 items-center">
                                                <label for="description"
                                                    class="form-label w-full lg:max-w-xs text-sm font-medium text-gray-700">Descripción</label>
