            ...
            <div class="grid gap-5 lg:gap-7.5">
                <div class="col-span-2">
                    <div class="flex flex-col gap-5 lg:gap-7.5">
                            ...
                            <form id="updateInfoCompany" action="{{ route('company.update', $companies->id) }}"
                                ...
                                <div class="card-body lg:py-7.5 py-5" style="margin-bottom: 50px;">
                                    ...
                                    <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14 mt-5">
                                        ...
                                        <div class="flex flex-wrap sm:flex-nowrap w-full gap-5 lg:gap-7.5">
                                            <img id="logo-small-preview" class="mt-2"
                                                src="{{ $companies->small_logo ? asset($companies->small_logo) : asset('/assetsBackend/media/avatars/blank.png') }}"
                                                style="height:100px;" />
                                        </div>
                                        <div class="flex justify-center items-center">
                                            <div class="image-input size-[200px]" data-image-input="true">
                                                <input id="logo-small-input" accept=".png, .jpg, .jpeg" name="small_logo"
                                                    type="file" class="custom-file-input" style="display: none;" />
                                    ...
                                    <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14 mt-5">
                                        ...
                                        <div class="flex flex-wrap sm:flex-nowrap w-full gap-5 lg:gap-7.5">
                                            <img id="logo-dark-preview" class="mt-2"
                                    ...
                                    <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14 mt-5">
                                        ...
                                        <div class="flex flex-wrap sm:flex-nowrap w-full gap-5 lg:gap-7.5">
                                            <img id="logo-light-preview" class="mt-2"
                                                src="{{ $companies->light_logo ? asset($companies->light_logo) : asset('/assetsBackend/media/avatars/blank.png') }}"
                                                style="height:100px;" />
                                        </div>
                                        <div class="flex justify-center items-center">
                                            <div class="image-input size-[200px]" data-image-input="true">
                                                <input id="logo-light-input" accept=".png, .jpg, .jpeg" name="light_logo"
                                                    type="file" class="custom-file-input" style="display: none;" />
                                                <button type="button" class="upload-button"
                                    ...
                                    <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14 mt-5">
                                        ...
                                        <div class="w-full">
                                            <div x-data="{
                                                ...
                                                <div class="mb-4">
                                                    <label for="platform" class="block text-gray-700">Nombre de la
                                                        plataforma:</label>
                                                    <input type="text" id="platform" x-model="platform"
                                                        class="input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                                </div>
                                                ...
                                                <div class="mt-6 w-full">
                                                    <h3 class="text-lg font-medium text-gray-700">Redes Sociales Añadidas:
                                                    </h3>
                                                    <div class="overflow-x-auto">
                                                        <table class="min-w-full bg-white">
                                                            ...
                                                            <tbody>
                                                                <template x-for="(social, index) in socialMedia"
                                                                    :key="index">
                                                                    <tr>
                                                                        <td class="px-6 py-4 border-b border-gray-200">
                                                                            <span x-text="social.platform"
                                                                                class="text-sm leading-5 text-gray-700"></span>
                                                                        </td>
                                                                        <td class="px-6 py-4 border-b border-gray-200">
                                                                            <span x-text="social.url"
                                                                                class="text-sm leading-5 text-gray-700"></span>
                                                                        </td>
                                                                    </tr>
                                                                </template>
                        ...
                        <livewire:backend.pages.red-social :companies="$companies"/>
                    </div>
                </div>
            </div>
        </div>
