                ...
                <div class="col-span-2">
                    <div class="flex flex-col gap-5 lg:gap-7.5">
                        ...
                        <div class="card min-w-full">
                            <form id="createCarrusel" action="{{ route('carrusel.update', $carrusel->id) }}" method="POST"
                                ...
                                <div class="card-body lg:py-7.5 py-5">
                                    <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14">
                                        ...
                                        <label class="input">
                                            <input type="text" value="{{ $carrusel->small_title }}"
                                                placeholder="Este título aprece primero." name="small_title" />
                                        </label>
                                    </div>
                                    <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14 mt-5">
                                        ...
                                        <label class="input">
                                            <input type="text" value="{{ $carrusel->big_title }}" name="big_title"
                                    ...
                                    <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14 mt-5">
                                        ...
                                        <label class="w-full">
                                            <textarea name="description" class="textarea w-full" placeholder="Agregar su descripción..." rows="6">
                                    ...
                                    <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14 mt-5">
                                        ...
                                        <div class="flex flex-wrap sm:flex-nowrap w-full gap-5 lg:gap-7.5">
                                            <img id="mobile-bg-preview" class="mt-2"
                                                src="{{ $carrusel->mobile_background ? asset($carrusel->mobile_background) : asset('/assetsBackend/media/avatars/blank.png') }}"
                                                style="height:100px;" />
                                        </div>
                                    ...
                                    <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14 mt-5">
                                        ...
                                        <div class="flex flex-wrap sm:flex-nowrap w-full gap-5 lg:gap-7.5">
                                            <img id="desktop-bg-preview" class="mt-2"
                                                src="{{ $carrusel->desktop_background ? asset($carrusel->desktop_background) : asset('/assetsBackend/media/avatars/blank.png') }}"
                                                style="height:100px;" />
                                        </div>
                                        <div class="flex justify-center items-center">
                                            <div class="image-input size-[500px]" data-image-input="true">
                                    ...
                                    <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14 mt-5">
                                        ...
                                        <div class="flex flex-wrap sm:flex-nowrap w-full gap-5 lg:gap-7.5">
                                            <img id="tablet-bg-preview" class="mt-2"
                                                src="{{ $carrusel->tablet_background ? asset($carrusel->tablet_background) : asset('/assetsBackend/media/avatars/blank.png') }}"
                                                style="height:100px;" />
                                        </div>
                                        <div class="flex justify-center items-center">
                                            <div class="image-input size-[500px]" data-image-input="true">
                                    ...
                                    <div class="border-t border-gray-200 my-7.5"></div>º
                                    <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14">
                                        <div class="flex flex-col max-w-72 w-full">
                                            <div class="text-gray-900 text-sm font-semibold">
                                                Agragar botones
