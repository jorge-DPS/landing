            ...
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                <div class="flex flex-col justify-center gap-2">
                    <h1 class="text-xl font-semibold leading-none text-gray-900">
                        Administración de galeria
                    </h1>
                </div>
                <div class="flex items-center gap-2.5">
                    <div class="flex items-center gap-2.5">
                        <div class="btn-conteiner">
                            <a class="btn-content" href="{{ route('activities.index') }}">
        ...
        <div class="container-fixed">
            <div class="grid gap-5 lg:gap-7.5">
                <div class="card card-grid min-w-full">
                    <div class="card-body">
                        {{-- Añadir imagenes --}}
                        <livewire:backend.activity.add-images-activity :activity="$activity">

                        {{-- mostrando las imagenes --}}
                        <livewire:backend.activity.images-activity :activity="$activity">
