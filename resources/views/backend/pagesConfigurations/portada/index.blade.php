...
@section('breadcrumbs')
    <div class="flex [.header_&amp;]:below-lg:hidden items-center gap-1.25 text-xs lg:text-sm font-medium mb-2.5 lg:mb-0"
        ...
        <span class="text-gray-600">
            {{ Breadcrumbs::render('portada.index', $page, $section) }}
        </span>
            ...
            <div class="flex flex-wrap items-center justify-between gap-5 pb-7.5">
                <div>
                    <h1 class="text-xl font-semibold text-gray-900">
                        Portadas de la Sección: {{ $section->title }}
                    </h1>
                    <p class="text-sm text-gray-600">Lista de portadas asociados a esta sección</p>
                </div>
            </div>
                ...
                <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                    ...
                    <div class="flex items-center gap-2.5">
                        <div class="btn-conteiner">
                            @if ($cover)
                                <!-- Si ya existe una portada, mostramos el botón de editar -->
                                <a class="btn-content" href="{{ route('portada.edit', ['section' => $section, 'page' => $page, 'cover' => $cover]) }}">
                                    <span class="btn-title">EDITAR</span>
                            ...
                            @else
                                <!-- Si no hay portada, mostramos el botón de crear -->
                                <a class="btn-content" href="{{ route('portada.create', ['section' => $section, 'page' => $page]) }}">
