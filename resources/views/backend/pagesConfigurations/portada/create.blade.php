    ...
    <div class="flex [.header_&amp;]:below-lg:hidden items-center gap-1.25 text-xs lg:text-sm font-medium mb-2.5 lg:mb-0"
       ...
       <span class="text-gray-600">
        ...
        <span class="text-gray-700">
            {{ Breadcrumbs::render('portada.create', $page, $section) }}
       </span>
    </div>
{{--
    <div class="flex [.header_&amp;]:below-lg:hidden items-center gap-1.25 text-xs lg:text-sm font-medium mb-2.5 lg:mb-0"
            ...
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                ...
                <div class="flex items-center gap-2.5">
                    <div class="btn-conteiner">
                        <a class="btn-content" href="{{ route('portada.index', [$page, $section]) }}">
                ...
                <div class="col-span-2">
                    <div class="flex flex-col gap-5 lg:gap-7.5">
                        <div class="card min-w-full">
                            ...
                            {{-- {{ dd($page) }} --}}
                            <livewire:backend.section-portada.portada-create :section="$section" :page="$page"/>
